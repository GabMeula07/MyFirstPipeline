...
class TwitterHook(HttpHook):
    ...
    def create_url(self):
        ...
        print(base_url)
        url_raw = f"{base_url}/2/tweets/search/recent?query={query}&{tweet_fields}&{user_fields}&start_time={start_time}&end_time={end_time}"
        return url_raw
    ...
    # função obrigatória para o hook funcionar
